        ...
        <Section style={sectionStyle}>
          ...
          <Row>
            <Text style={textStyle}>
              Thank you for registering. To complete your account setup, please
          ...
          <Row>
            <Text style={textStyle}>
              ...
              code, please disregard this email.
            </Text>
          </Row>
          <Row>
            <Button
              href={`https://yourapp.com/verify/${username}`}
              style={buttonStyle}
            >
              Verify Account
            </Button>
          ...
          <Row>
            <Text style={footerStyle}>
              ...
              following link into your web browser: https://yourapp.com/verify/
              {username}
            </Text>
          </Row>
        </Section>
